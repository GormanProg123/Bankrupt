          ...
          <form
              ...
              >
                  <div className="form-header pb-4 sm:pb-6 flex flex-col lg:flex-row lg:justify-between lg:items-start w-full space-y-4 lg:space-y-0">
                      <div className="flex-1">
                          ...
                          <p className="text-base sm:text-lg lg:text-xl text-gray-500 mt-1">Select accounts and enter transfer details</p>
                      </div>
              ...
              <div className="w-full mx-auto font-sans">
                <div className="bg-gray-100 sm:bg-gray-200 rounded-lg p-4 sm:p-6">
                  <h2 className="text-base sm:text-lg font-bold mb-3 sm:mb-4">Transfer Summary</h2>
                  
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                      <div className="text-gray-500 text-sm sm:text-base">Transfer Type</div>
                      <div className="font-medium text-sm sm:text-base">Standard</div>
                    </div>
                    
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                      <div className="text-gray-500 text-sm sm:text-base">From</div>
                      <div className="font-medium text-sm sm:text-base break-all">(*{formData.from_card_number.slice(-4)})</div>
                    </div>
                    
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                      <div className="text-gray-500 text-sm sm:text-base">To</div>
                      <div className="font-medium text-sm sm:text-base break-all">(*{formData.to_card_number.slice(-4)})</div>
                    </div>
                    
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                      <div className="text-gray-500 text-sm sm:text-base">Amount</div>
                      <div className="font-medium text-sm sm:text-base">${formData.amount}</div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                      ...
                      <div className="font-bold text-sm sm:text-base">${formData.amount}</div>
                    </div>
                  </div>
                </div>
                
                <div className="mt-4 border border-gray-200 rounded-lg p-3 sm:p-4">
                  <h3 className="font-bold mb-2 text-sm sm:text-base">Important Information</h3>
